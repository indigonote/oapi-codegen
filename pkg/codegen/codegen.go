...
var (
	allGoImports = goImports{
		...
		{lookFor: "openapi_types\\.", alias: "openapi_types", packageName: "sios.tech/indigo/oapi-codegen/pkg/types"},
		{lookFor: "path\\.", packageName: "path"},
		{lookFor: "runtime\\.", packageName: "sios.tech/indigo/oapi-codegen/pkg/runtime"},
